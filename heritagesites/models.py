...
class Planet(models.Model):
    ...
    unsd_name=models.CharField(unique=False,max_length=50,null=True)
...
class Location(models.Model):
    ...
    sub_region = models.ForeignKey('SubRegion', on_delete=models.CASCADE,blank=True,null=True)
    intermediate_region = models.ForeignKey('IntermediateRegion', on_delete=models.CASCADE,blank=True,null=True)
...
class HeritageSite(models.Model):
    ...
    def region_names(self):
        ...
        regions = self.country_area.select_related('location').values(region_name=F('location__region__region_name')).order_by('location__region__region_name')
    ...
    def sub_region_names(self):
        ...
        subregions = self.country_area.select_related('location').values(sub_region_name=F('location__sub_region__sub_region_name')).order_by('location__sub_region__sub_region_name')
    ...
    def intermediate_region_names(self):
        ...
        # string join method.
        intermediateregions = self.country_area.select_related('location').values(intermediate_region_name=F('location__intermediate_region__intermediate_region_name')).order_by('location__intermediate_region__intermediate_region_name')

        names = []
        for intermediateregion in intermediateregions:
            name = intermediateregion['intermediate_region_name']
            if name is None:
                continue
